...
public class SBALBSlashArtRegsitry {
    ...
    public static final RegistryObject<ComboState> terrifyingwaves = COMBO_STATES.register("terrifying_waves",
            ComboState.Builder.newInstance().startAndEnd(400, 459).priority(50)
                    ...
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            ...
                            .put(3, (entityIn) -> WaterDrive.doSlash(entityIn,90,10,Vec3.ZERO,false,1.0,1F))
                            .put(4, (entityIn) -> WaterDrive.doSlash(entityIn,90,10,Vec3.ZERO,false,1.0,1F))
                            .put(5, (entityIn) -> WaterDrive.doSlash(entityIn,90,10,Vec3.ZERO,false,1.0,1F))
                            .put(6, (entityIn) -> WaterDrive.doSlash(entityIn,90,10,Vec3.ZERO,false,1.0,1F))
                            .put(7, (entityIn) -> WaterDrive.doSlash(entityIn,90,10,Vec3.ZERO,false,1.0,1F))
                            .put(8, (entityIn) -> WaterDrive.doSlash(entityIn,90,10,Vec3.ZERO,false,1.0,1F))
                            .put(9, (entityIn) -> WaterDrive.doSlash(entityIn,90,10,Vec3.ZERO,false,1.0,1F))
                            .build())
    ...
    public static final RegistryObject<ComboState> lightinggwaves = COMBO_STATES.register("lighting_swordsex",
            ComboState.Builder.newInstance().startAndEnd(400, 459).priority(50)
                    ...
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            .put(2, (entityIn) -> AttackManager.doSlash(entityIn, -30F, Vec3.ZERO, false, false, 0.1F))
                            .put(3, (entityIn) -> LightingSwords.doSlash(entityIn,false,20.5,5F))
                            .put(4, (entityIn) -> LightingSwords.doSlash(entityIn,false,20.5,5F))
                            .put(5, (entityIn) -> LightingSwords.doSlash(entityIn,false,20.5,5F))
                            .put(6, (entityIn) -> LightingSwords.doSlash(entityIn,false,20.5,5F))
                            .build())
                    .addHitEffect(StunManager::setStun)
                    ::build);
